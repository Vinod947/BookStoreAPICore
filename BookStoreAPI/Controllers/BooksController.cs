...
namespace BookStoreAPI.Controllers
{
    ...
    public class BooksController : ControllerBase
    {
        ...
        [HttpDelete("{id}")]
        public ActionResult<IEnumerable<Book>> DeletetBook(int id)
        {
        ...
        [HttpPut("{id}")]
        public ActionResult<IEnumerable<Book>> UpdatetBook(int id, [FromForm]Book book)
        {
            var obook = books.UpdateBook(id,book);
           if(obook != null)
            {
                return obook;
            }
